...
define('THIRSTY_VERSION', '2.6.1', true);
...
function thirstyLinkUrlMeta() {
    ...
    $linkData['linkurl'] = str_replace('%7B', '{', $linkData['linkurl']);
    $linkData['linkurl'] = str_replace('%7D', '}', $linkData['linkurl']);
    $linkData['linkurl'] = html_entity_decode((!empty($linkData['linkurl']) ? $linkData['linkurl'] : ''));
	...
	echo '<p><input id="thirsty_linkurl" name="thirsty[linkurl]" value="' . $linkData['linkurl'] . '" size="50" type="text" /></p>';
